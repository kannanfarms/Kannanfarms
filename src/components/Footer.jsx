        ...
        <div className="max-w-5xl mx-auto flex flex-wrap justify-center gap-6 md:gap-10">
          {TRUST_ITEMS.map((item, i) => (
            <motion.div
              ...
              className="flex items-center gap-2.5 text-white font-medium text-[13px]"
            >
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-10 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          >
            ...
            <div className="text-[10px] text-white/60 tracking-[2px] uppercase mb-5">
              Natural Products for a Healthier You
            </div>
            <p className="text-white/80 text-[13px] leading-relaxed max-w-xs">
          ...
          >
            <div className="text-[11px] font-semibold tracking-[2px] uppercase text-white/60 mb-5">
              Quick Links
            </div>
            <div className="flex flex-col gap-3">
              {FOOTER_LINKS.map((link) => (
                <Link
                  key={link.label}
                  to={link.to}
                  className="text-white/80 hover:text-mint-glow text-[13px] transition-colors duration-200 w-fit"
                >
                  {link.label}
                </Link>
              ))}
          ...
          >
            ...
            <div className="flex flex-col gap-3 text-[13px] text-white/80">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="https://wa.me/916381594945" target="_blank" rel="noopener noreferrer" className="hover:text-mint-glow transition-colors">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="https://instagram.com/kannan.farms" target="_blank" rel="noopener noreferrer" className="hover:text-mint-glow transition-colors">
                  @kannan.farms
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:kannansfarms@gmail.com" className="hover:text-mint-glow transition-colors">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/7 border border-white/10 flex items-center justify-center text-white/60 hover:text-mint-glow hover:border-mint-glow/40 hover:bg-mint-glow/10 transition-all duration-200"
              >
